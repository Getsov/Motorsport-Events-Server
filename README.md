...
Retrieve all personal events awaiting approval, which have not been deleted. This endpoint is accessible exclusively for active and approved administrators and organizers.

- **Method:** `GET`
- **Endpont:** `/user/myEventsForApproval`

Retrieve all personal events scheduled for the future that have not been deleted and are approved. This endpoint is accessible only to active and approved administrators and organizers.

- **Method:** `GET`
- **Endpont:** `/user/myUpcomingEvents`

Retrieve all personal events that have already taken place and have not been deleted, provided they are approved. This endpoint is available solely to active and approved administrators and organizers.

- **Method:** `GET`
- **Endpont:** `/user/myPastEvents`
